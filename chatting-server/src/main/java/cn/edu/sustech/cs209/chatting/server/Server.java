            ...
            try {
                ...
                while ((message = in.readLine()) != null) {
                    ...
                    if (object.get("command").equals(Message.SendPrivateMsg)) {
                        ...
                        Message tem = new Message(object.get("command").toString(), object.get("sender").toString(), object.get("receiver").toString(), Long.parseLong(object.get("time").toString()), object.get("content").toString());
